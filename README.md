...
2. Navigate to the project directory: `cd ITMD542-LAB2` or by using this -> git clone https://github.com/SamhithaSampath/ITMD542-LAB2.git <new-directory>.(Example:git clone <repository-url> <new-directory>).
